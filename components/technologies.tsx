  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 128 128" className="w-10 h-10">
        ...
        <path fill="var(--background)" d="M106.317 112.014L49.167 38.4H38.4v51.179h8.614v-40.24l52.36 67.884a64.216 64.216 0 006.943-5.209zM81.057 38.4h8.533v51.2h-8.533z"/>
      </svg>
    ),
...
function TechCard({ tech, index }: { tech: typeof technologies[0]; index: number }) {
  ...
  return (
    ...
    >
      <motion.div
        className="relative flex flex-col items-center p-6 rounded-2xl bg-card/50 backdrop-blur-md border border-border hover:border-primary/50 transition-all duration-500 overflow-hidden"
      ...
      >
        ...
        {/* Icon */}
        <motion.div
          className="relative mb-4 p-3 rounded-xl bg-secondary/50"
        ...
        {/* Name */}
        <span className="relative font-semibold text-foreground text-sm mb-3 group-hover:text-primary transition-colors">
          {tech.name}
        </span>
        ...
        <span className="relative text-xs text-muted-foreground mt-2">{tech.level}%</span>
      </motion.div>
    </motion.div>
  )
}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Estas son las tecnologías con las que trabajo día a día para crear 
              experiencias web modernas y de alto rendimiento.
            </p>
          </motion.div>
